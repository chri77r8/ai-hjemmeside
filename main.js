...
function mistralChat(prompt, apiKey) {
    return fetch("https://api.mistral.ai/v1/chat/completions", {
        ...
        body: JSON.stringify({
            ...
            messages: [
                { role: "system", content: "You are an expert in easy and fast recipes, that must always be gluten free. You must use some of the ingredients that I give, but you are allowed to add more ingredients to the recipe. The measurements in the recipe needs to be in the metric system"},
